    ...
    return JobData ? (
        <>
            ...
            <div className='min-h-screen flex flex-col py-10 container px-4 2xl:px-20 mx-auto'>
                {/* 🔄 STRUCTURE REARRANGED HERE */}
                <div className='bg-white text-black rounded-lg w-ful'>
                    <div className='flex justify-between items-center flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
